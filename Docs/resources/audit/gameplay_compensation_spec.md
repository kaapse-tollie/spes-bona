...
- Hook family:
  - [`common/static_modifiers/sb_modifiers.txt`](../../../common/static_modifiers/sb_modifiers.txt)
  - [`common/on_actions/sb_on_actions.txt`](../../../common/on_actions/sb_on_actions.txt)
...
- Keep out of caps: `yes`
- Hook family:
  - [`common/journal_entries/1-07_sb_bst_frontier.txt`](../../../common/journal_entries/1-07_sb_bst_frontier.txt)
  - [`common/on_actions/sb_bst_on_actions.txt`](../../../common/on_actions/sb_bst_on_actions.txt)
- Implementation direction:
