...
ARABLE_BASKET_SEEDS = {
    ...
    "Northern Cape": {
        "yes_resources": {"Cotton Plantation", "Livestock Ranch", "Vineyard", "Wheat Farm"},
        "include_summary": "Northern Cape covers inland South African Namaqualand, Karoo grazing, Orange-Vaal irrigation, and dry-country cotton pockets; wheat is retained as the single cereal-farm slot.",
    ...
    "Eastern Cape": {
        "yes_resources": {"Livestock Ranch", "Maize Farm", "Tobacco Plantation"},
        "include_summary": "Eastern Cape is a mixed grain-and-livestock state centered on maize and stock, with only weaker tobacco pockets; maize is retained as the single cereal-farm slot.",
    ...
    "West Transvaal": {
        "yes_resources": {"Livestock Ranch", "Maize Farm", "Tobacco Plantation"},
        "include_summary": "West Transvaal covers Gauteng plus the plateau-side old North West / western Transvaal grain-and-stock belt, where maize, livestock, and only a smaller tobacco allowance fit best; maize is retained as the single cereal-farm slot.",
    ...
    "Transorangia": {
        "yes_resources": {"Livestock Ranch", "Maize Farm", "Tobacco Plantation"},
        "include_summary": "Free State is a classic interior maize-and-livestock state with only a weak tobacco allowance; maize is retained as the single cereal-farm slot.",
    ...
    "Zululand": {
        "yes_resources": {"Banana Plantation", "Cotton Plantation", "Livestock Ranch", "Maize Farm", "Sugar Plantation", "Tea Plantation", "Tobacco Plantation"},
        "include_summary": "Zululand covers the full KwaZulu-Natal split-state footprint; sugar, maize, livestock, bananas, cotton, tea, and tobacco are localized across different KZN subregions inside one state, with maize retained as the single cereal-farm slot.",
    ...
    "Drakensberg": {
        "yes_resources": {"Livestock Ranch", "Maize Farm"},
        "include_summary": "Lesotho is a grain-and-livestock highland where maize and stock define the mountain-constrained basket; maize is retained as the single cereal-farm slot.",
    ...
    "Botswana": {
        "yes_resources": {"Livestock Ranch", "Millet Farm"},
        "include_summary": "Botswana is livestock-first across the full state footprint, with drought-grain support concentrated in the east and smaller wetter pockets in the north-west corridor; millet represents the single cereal-farm slot.",
    ...
    "Lourenço Marques": {
        "yes_resources": {"Banana Plantation", "Cotton Plantation", "Livestock Ranch", "Maize Farm", "Sugar Plantation"},
        "include_summary": "Lourenço Marques covers the full southern Mozambique split-state footprint from Maputo through Gaza and Inhambane to the southern Pungwe-facing provinces; lowland maize, bananas, sugar, cotton, and some livestock dominate through localized belts inside that footprint, with maize retained as the single cereal-farm slot.",
    ...
    "Zambezi": {
        "yes_resources": {"Coffee Plantation", "Cotton Plantation", "Livestock Ranch", "Maize Farm", "Sugar Plantation", "Tea Plantation", "Tobacco Plantation"},
        "include_summary": "Zambezi covers the full Zimbabwe split-state footprint; maize, tobacco, cotton, cattle, sugar, and pocket tea-and-coffee are localized across different belts inside one state, with maize retained as the single cereal-farm slot.",
    ...
    "Hereroland": {
        "yes_resources": {"Livestock Ranch", "Millet Farm"},
        "include_summary": "Hereroland covers the full northern Namibia split-state footprint; millet and livestock are localized between the northern communal belt, the Otavi-Grootfontein pocket, and the central plateau, with millet retained as the single cereal-farm slot.",
