...
Static implementation targets Victoria 3 `1.13.11` (build `24799966`, checksum `a47f`) and CMF `1.65.0` (`d832d15`). The cases below require a real game process and are not certified by repository tests.
...
|---|---|---|---|
| `RV-01` | Cold launch a fresh 1836 game with CMF 1.65.0 and SB, then save and reload. | No new parser, missing-scope, stale-JE, or duplicate Situation-widget errors. | Engine pending |
