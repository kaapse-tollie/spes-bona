...
Static implementation targets Victoria 3 `1.13.10` (build `24689003`) and CMF `1.61.0` (`9b999e3`). The cases below require a real game process and are not certified by repository tests.
...
|---|---|---|---|
| `RV-01` | Cold launch a fresh 1836 game with CMF 1.61.0 and SB, then save and reload. | No new parser, missing-scope, stale-JE, or duplicate Situation-widget errors. | Engine pending |
