...
| `FA-29` | **Re-audited (2026-08-23).** Natal whaling is retained at `4`, with reduced Zululand at `0`: localized pre-1937 evidence supports six Bluff/Park Rynie firms by 1913 and substantial 1928 shore throughput. The lower `2` proposal over-weighted an opening season and later one-firm consolidation; `4` is a bounded qualitative exception, not a one-firm/one-level formula. Full decision record: `../References/Resource rework/resources/data/raw/natal_whaling_cap_factcheck.md`. "Truimph" typo fixed. GZA capital abstraction documented in-file. KLR display-name question deferred — the naming reaches loc, flags, file names and tests, and DP has not asked for the rename. |
