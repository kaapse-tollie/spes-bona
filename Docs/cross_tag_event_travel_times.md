...
| `sb_imperial_confederation.040 -> sb_anglo_zulu.010`, Natal accelerates the frontier | 1870s | Same NAL country after an imperial decision | Political preparation | `30 days` | Not a cross-capital message; `30 days` is a narrative preparation period and is sound. |
| `sb_anglo_zulu.010-.030`, ultimatum and Anglo-Zulu conflict | Around 1879 | Pietermaritzburg-Ulundi `170 km`; London-Ulundi `9,400 km` if read literally as a London order | Natal courier; Europe cable only from late 1879 | Opening immediate; war results after `3 days` | Local Natal ultimatum `2 days`; London authorization about `20 days` before the cable or `1 day` after it. Outcome events are mechanical and can remain short. |
| `sb_bst_frontier.200/.220`, Basotho transfer and Gun War | 1879-1881 normally | Cape Town-Thaba Bosiu `1,010 km`; London-Thaba Bosiu `9,390 km` | Interior and international telegraph by this period | Event or DP created immediately once gates pass | `1 day` for a political message. The play and its goals are one action and need no extra delay. |
...
| `sb_mozambique_company.010`, Portugal creates or declines MZQ | Around 1891 onward | Lisbon-Maputo `8,400 km` | International telegraph | One event performs the administrative settlement | `0-1 day` as one administrative act. A later MZQ acceptance event, if added, should use `1 day`. |
